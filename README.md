...
- [ ] Explain what a token is used for.
  ...
  A token is used to authorize a login.

- [ ] What steps can you take in your web apps to keep your data secure?

  Set up private routes. with auth login

- [ ] Describe how web servers work.

  When u send a url request for example it travels through wires to the server and requests that URL if the server has the url it will sent it back. if not u get error. 
